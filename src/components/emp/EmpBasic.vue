            ...
            <el-col :span="7">
              <div>
                <el-form-item label="年龄:" prop="age">
                  <el-input prefix-icon="el-icon-edit" v-model="emp.age" size="mini" style="width: 120px"
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="电话号码:" prop="phone">
                  <el-input prefix-icon="el-icon-phone" v-model="emp.phone" size="mini" style="width: 130px"
    ...
    data() {
      return {
        ...
        rules: {
          ...
          birthday: [{required: true, message: '必填:年龄', trigger: 'blur'}],
